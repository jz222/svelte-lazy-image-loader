...
<style>
    ...
    .shimmer:before {
        ...
        width: 50%;
        height: 100%;
        background: -webkit-gradient(linear, left top, right top, color-stop(20%, rgba(255, 255, 255, 0)), to(#E5E5E5));
    ...
    .shimmer:after {
        ...
        width: 50%;
        height: 100%;
        background: -webkit-gradient(linear, left top, right top, from(#E5E5E5), color-stop(20%, rgba(255, 255, 255, 0)));
